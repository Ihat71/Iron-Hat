...
from services.workout_template_exercises_service import (
...
from schemas.workout_template_exercises import WorkoutTemplateExerciseCreate, WorkoutTemplateExerciseRead, WorkoutTemplateExerciseUpdate
